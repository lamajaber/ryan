...
@endif
    ...
    <div class="container">
      <div class="row mt-5">
        ...
        <div
          ...
          <h2 class="about-heading">دعم وتواصل علىى مدار <span class="number">24</span> ساعة</h2>
          <p class="about_description">نعتني بزبائننا على الدوام
              الطلب مفتوح  والدعم الفني على اتصال، نعتني بزبائننا على الدوام
            الاستشارات مفتوحة
  ...
  <section class="testimonials  animate__animated animate__slower animated__delay-10s animate__fadeInUp"
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <h2 class="main-color text-center pb-4">منتجاتنا</h2>
        </div>
      </div>
<div class="row" >
        <div class="col-md-3" >;
            ...
            <img src="/tamkeen-proj/assets/imgs/1.png"   alt="...">
